...
urlpatterns = [
    ...
    path('internship/register/', views.internship_register, name="internship-register"),
    path('submit-registration/', views.internship_submit_reg, name="internship-submit-registration"),
